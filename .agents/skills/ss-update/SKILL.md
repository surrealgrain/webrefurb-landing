...
# Find skills
find . -path "*/.Codex/skills/ui-*" -o -path "*/.Codex/skills/ux-*" | head -20
...
- Check if Golden Rules exist in AGENTS.md
...
- Copy skills: `cp -r /tmp/styleseed/engine/.Codex/skills/ .Codex/skills/`
