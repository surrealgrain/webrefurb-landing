...
EXCLUDED_BUSINESS_TOKENS = (
    ...
    "中華料理", "中国料理", "中華菜館", "タイ料理", "ワインバー", "ダーツ", "うどん",
)
...
IZAKAYA_MENU_TERMS = (
    "居酒屋", "お通し", "刺身", "焼き鳥", "焼鳥", "やきとり", "串焼き", "やきとん",
    "串カツ", "串かつ", "串揚げ", "おでん", "炉端焼き", "海鮮", "鮮魚", "揚げ物", "唐揚げ",
...
IZAKAYA_CATEGORY_TERMS = (
    "izakaya", "居酒屋", "飲み屋", "酒場", "sakaba", "yakitori", "焼き鳥",
    "焼鳥", "やきとり", "kushiyaki", "串焼き", "yakiton", "やきとん",
    "kushikatsu", "串カツ", "串かつ", "kushiage", "串揚げ", "oden", "おでん",
    "robatayaki", "炉端焼き", "海鮮居酒屋",
