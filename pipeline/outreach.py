...
def build_outreach_email(
    *,
    ...
    english_body = _join_paragraphs([
        ...
        tmpl["genre_intro_en"],
        "This works with your existing Japanese menu and POS system — no changes needed.",
        "Customers scan a QR code placed in the restaurant and view dish descriptions and photos in English on their phone.",
        'They can add dishes to an "Order List", then show a screen with Japanese item names, quantities, and options to your staff.',
    ...
    *,
    ...
    if channel == "contact_form":
        ...
        english_body = _join_paragraphs([
            ...
            'The demo loads in Japanese by default. Use the "EN / JP" toggle at the top to see the English view your customers would see.',
            "If this could be useful, please let us know through this form.",
            "Thank you for your consideration.",
            f"{sender_name}\nWebRefurb\nhttps://webrefurb.com/",
        ])
    else:
