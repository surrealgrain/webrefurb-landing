...
- Clear photos or PDFs of the drink menu
- If there's a ticket machine: front-on photo showing all buttons, plus close-ups if text is small
- Any handwritten boards or daily specials (optional but helpful)"""
