...
def test_execution_plan_finishes_no_send_artifacts_without_promotion(tmp_path):
    ...
    assert yakitori["request_status"] == "covered_or_monitor"
    assert yakitori["asset_profile"] == "izakaya_food_drinks_menu"
    ...
    assert ramen["request_status"] == "locked_asset_available"
